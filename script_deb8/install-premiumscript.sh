...
cd /usr/local/bin
wget -O premium-script.tar.gz "https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/premium-script.tar.gz"
...
echo "Modified by Rey DC Luar Jr."
echo " "
