...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/screenfetch"
...
wget https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/vnstat_php_frontend-1.5.1.tar.gz
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/mrtg.conf" >> /etc/mrtg.cfg
...
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="FFAST"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="phcrey19@gmail.com"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU="MyOrganizationalUnit"|export KEY_OU="reyluar018"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="reyluar018"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=reyluar018|' /etc/openvpn/easy-rsa/vars
...
wget https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/ca.crt
chmod +x ca.crt
cd
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/badvpn-udpgw64"
fi
...
wget https://github.com/reyluar18/ddos-deflate/archive/master.zip
unzip master.zip
...
# download script
cd
wget https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/install-premiumscript.sh -O - -o /dev/null|sh
