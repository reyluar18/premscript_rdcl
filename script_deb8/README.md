...
`apt-get -y install wget && wget https://raw.githubusercontent.com/reyluar18/premscript_rdcl/master/script_deb8/ffastdeb8 && chmod +x ffastdeb8 && ./ffastdeb8 && rm -f ffastdeb8 && history -c
